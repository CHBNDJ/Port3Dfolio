...
const counterItems = [
  ...
  { value: 3000, suffix: "+", label: "Hours Spent Coding" },
];
...
const techStackIcons = [
  ...
  },
  {
    ...
    modelPath: "/models/mobile-transformed.glb",
    scale: 40,
    rotation: [0, 0, 0],
  },
...
const expCards = [
  ...
  },
  {
    ...
    responsibilities: [
      "Developed fully responsive landing pages matching professional designs.",
      "Optimized projects for cross-browser compatibility and mobile responsiveness.",
      "Implemented best practices for performance and accessibility.",
    ],
  },
  {
